...
class AppRoutes {
  ...
  static final menuOptions = <MenuOptions>[
    ...
    MenuOptions(route: 'general', name: 'Inventario General', screen: const GeneralScreen() , icon: Icons.inventory),
    MenuOptions(route: 'users', name: 'Gestión usuarios', screen: const UsersScreen() , icon: Icons.supervised_user_circle),
